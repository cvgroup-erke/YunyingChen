...
def build_targets(pred_boxes, pred_cls, target, anchors, ignore_thres):
    ...
    # 此两行目的：判断哪一个anchor该去预测那一个物体, 该物体bbox具有与anchor最大的iou
    ...
    # 到目前为止，还不知道我们应该靠哪一个cell去预测那一个物体，但是，我们已经知道了，无论靠哪一个cell，都应该用那一个anchor去预测
    ...
    for i, anchor_ious in enumerate(ious.t()):
        ...
        noobj_mask[b[i],
                   anchor_ious > ignore_thres,
                   gj[i],
                   gi[i]] = 0
        # box: 3 anchor
        # iou: 0.9, 0.85, 0.8 ——> om: 1, 0, 0
        #                     ——> nm: 0, 0, 0
    # FaceBoxes (SSD): github: bipartite matching + ohem (online hard example mining)
